...
class TestService(unittest.TestCase):
    ...
    def test_perform_diff(self) -> None:
    ...
    def test_signed_urls(self) -> None:
        urls = service.signed_urls('test')
        for url in urls.values():
            r = requests.get(url)
            r.raise_for_status()

    def test_signed_upload_urls(self) -> None:
        # end to end test
